...
public class MainActivity extends AppCompatActivity {
    ...
    private TextView stickerCountsTextView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        stickerCountsTextView = findViewById(R.id.stickerCountsTextView);
        ...
        sentRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (stickerCounts != null) {
                    StringBuilder countsText = new StringBuilder("Sticker Counts:\n");
                    for (Map.Entry<String, Long> entry : stickerCounts.entrySet()) {
                        countsText.append(entry.getKey()).append(": ").append(entry.getValue()).append("\n");
                    }
                    stickerCountsTextView.setText(countsText.toString());
                } else {
                    stickerCountsTextView.setText("No stickers sent yet.");
                }
            }
